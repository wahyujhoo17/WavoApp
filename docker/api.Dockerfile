...
# Use 'npm install' instead of 'npm ci' to resolve updated Baileys v7
...
# Use 'npm install' to resolve updated Baileys v7
RUN npm install --omit=dev --workspace=apps/api --workspace=packages/database
